...
const absensiController = require('../controllers/AbsensiLemburController');
...
router.get('/hrd/pending-hrd', absensiController.getPendingHRD);

router.put('/hrd/approve-hrd', absensiController.approveByHRD);
